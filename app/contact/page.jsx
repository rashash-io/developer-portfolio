      ...
      <div className="container  mx-auto ">
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:h-[54%] order-2 xl:order-none bg-[url('/bg.png')] bg-no-repeat bg-blend-color-dodge">
            <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-6 p-10 bg-black/40 rounded-xl shadow-lg">
              <h3 className="text-4xl text-accent">Let's work together</h3>
              <p className="text-white/60">Leave me a message & I'll get back to you asap.
              </p>
              {/* Input */}
              <div className="grid grid-cols-1 gap-6 ">
                <div className="relative ">
                    ...
                    <Input type="name" name="name" className="pl-12 border-2 w-full bg-darkernavy"placeholder="Name"/>
                </div>
                ...
                <div className="relative">
                  ...
                  <Input type="phone" name="phone" className="pl-12 w-full bg-darkernavy " placeholder="Phone number"/> 
                </div>
