...
// Components
import { Button, HomeSocialLinks } from "./";

export const HomeIntroCard = () => {
  return (
    <div className="text-center bg-[url('/bg.png')] bg-no-repeat bg-cover bg-blend-saturation bg-dark/80 xl:text-left p-6 mt-4 rounded-3xl border  border-accent order-2 xl:order-none hover:border-pinkred transition-all duration-700">
      <h1 className="text-pinkred/80">
        <strong>Hola! You can call me</strong>
      </h1>
      <h1 className="h1">
      ...
      <h1>
        <div className="flex justify-center align-center">
          <ul className="flex  md:pl-0 flex-col md:flex-row md:justify-center md:gap-6">
            <li className="flex gap-2 text-white/40 hover:text-white/90 transition-all duration-500">
              <span className="text-pinkred">{">"}</span>Engineer
            </li>
            <li className="flex gap-2 text-white/40 hover:text-white/90 transition-all duration-500">
              <span className="text-pinkred">{">"}</span>Web Developer
            </li>
            <li className="flex gap-2 text-white/40 hover:text-white/90 transition-all duration-500">
              <span className="text-pinkred">{">"}</span>Ethical Hacker
            </li>
          </ul>
        </div>
      </h1>
      <p className="leading-snug max-w-[500px] mb-4 text-white/60 hover:text-white transition-all duration-500">
        I excel at crafting & securing digital experiences and I am proficient
